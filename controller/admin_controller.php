...
class admin_controller implements admin_interface
{
	...
	*/
	public function display_options()
	{
		...
		$this->language->add_lang('acp_userdefaults', 'david63/userdefaults');
		...
		$this->template->assign_vars(array(
			...
			'S_AVATARS'					=> phpbb_optionget((int) constants::VIEWAVATARS, $this->config['ud_options']),
			'S_BBCODE'					=> phpbb_optionget((int) constants::BBCODE, $this->config['ud_options']),
			'S_DISABLE_CENSORS'			=> phpbb_optionget((int) constants::VIEWCENSORS, $this->config['ud_options']),
			'S_FLASH'					=> phpbb_optionget((int) constants::VIEWFLASH, $this->config['ud_options']),
			'S_IMAGES'					=> phpbb_optionget((int) constants::VIEWIMG, $this->config['ud_options']),
			'S_SMILIES'					=> phpbb_optionget((int) constants::SMILIES, $this->config['ud_options']),
			'S_SIG'						=> phpbb_optionget((int) constants::ATTACHSIG, $this->config['ud_options']),
			'S_SIGS'					=> phpbb_optionget((int) constants::VIEWSIGS, $this->config['ud_options']),
			'S_VSMILIES'				=> phpbb_optionget((int) constants::VIEWSMILIES, $this->config['ud_options']),
